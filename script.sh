...
rm -f velocidad-por-ano.csv
 ...
 do  sed 's/,/./g' $file | sed '1d' > $file"_"
    awk 'BEGIN {FS=";"; count=0}
            ...
            {prev=year[3]}' $file"_" >> velocidad-por-ano.csv
    rm $file"_"
 done

# Promedio  velocidad de estaciones por mes
rm -f velocidad-por-mes.csv
 for file in `ls estacion*.csv`;
 do fileout=$file"_1"
    ...
    awk 'BEGIN {FS=";"; count=0}
            ...
            {prev=mes[2]}' $file"_2" >> velocidad-por-mes.csv
    rm $file"_1" $file"_2"
 done

# Promedio velocidad por hora
rm  -f velocidad-por-hora.csv
for file in `ls estacion *.csv`;
 do fileout=$file"_1"
    ...
    awk 'BEGIN  {FS=";"; count=0}  
            ...
            {prev=hour[1]}'  $file"_2" >> velocidad-por-hora.csv
